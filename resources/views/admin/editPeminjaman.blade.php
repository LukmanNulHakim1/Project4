                    ...
                    <div class="card-body">
                        ...
                        <form action="/postEditPeminjaman/{{ $data->id }}" method="POST">
                            ...
                            <div class="form-group mt-1">
                                ...
                                <input type="date" class="form-control border border-secondary" name="tanggalPeminjaman" required value="{{ $data->tanggal_pinjam }}">
                            ...
                            <div class="form-group mt-1">
                                ...
                                <input type="date" class="form-control border border-secondary" name="tanggalPengembalian" required value="{{ $data->tanggal_kembali }}">
